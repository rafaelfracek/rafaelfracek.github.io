...
window.addEventListener('load', function() {
    ...
    addClickEventListenerToArrows(tetrisRacingGame);
});
...
function addClickEventListenerToArrows(tetrisRacingGame) {
    document.getElementById('arrow-left').addEventListener('click', () => tetrisRacingGame.moveLeft());
    document.getElementById('arrow-right').addEventListener('click', () => tetrisRacingGame.moveRight());
}
